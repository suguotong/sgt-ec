// 买五金正式环境域名跳转
// 欧阳军  调整为 http://mwjwxtest.buywujin.com 图片地址不变  http://buywujin.com/
module.exports = {
  // apiServer: 'http://mwjapp.buywujin.com', // 买五金正式环境接口地址
  // apiServer: 'http://localhost:8085', // 买五金支付测试地址
  apiServer: '/api', // 买五金支付测试地址
  // apiServer: 'http://mwjapp.irddtest.cn', // 买五金测试接口/买五金灰度接口
  // apiServer: 'http://mwjapp.irddtest.cn', // 金磊地址
  // apiServer: 'http://192.168.1.63:8083', // 买五金开发接口
  ...
  imgServer: 'http://img.kukuwu.com/' // 买五金正式图片服务器地址
}
